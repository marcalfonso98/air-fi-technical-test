"""
Django settings for qr_scanner_webapp project.
...
SECRET_KEY = 'django-insecure-okqna95sjkwn$b5dkvdwow$gw=dar^lg(op-$%-qyptq@en7ze'
...
WSGI_APPLICATION = 'qr_scanner_webapp.wsgi.application'
